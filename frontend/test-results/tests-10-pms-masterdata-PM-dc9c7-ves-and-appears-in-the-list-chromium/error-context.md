...
- Name: tests/10-pms-masterdata.spec.ts >> PMS MasterData >> Create stretch — new form saves and appears in the list
- Location: e2e/tests/10-pms-masterdata.spec.ts:106:7
