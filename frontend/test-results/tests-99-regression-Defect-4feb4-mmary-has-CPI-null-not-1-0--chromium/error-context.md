...
- Name: tests/99-regression.spec.ts >> Defect Regression Matrix >> BUG-010: Empty project cost summary has CPI null (not 1.0)
- Location: e2e/tests/99-regression.spec.ts:60:7

# Error details

```
Error: API 401: {"error":{"code":"UNAUTHORIZED","message":"Invalid username or password"},"meta":{"timestamp":"2026-04-25T03:48:41.612538Z","version":"0.1.0"}}
```
