...
- Name: tests/99-regression.spec.ts >> Defect Regression Matrix >> BUG-046: GET /v1/projects/{p}/relationships/{id} → 200
- Location: e2e/tests/99-regression.spec.ts:117:7

# Error details

```
Error: API 401: {"error":{"code":"UNAUTHORIZED","message":"Invalid username or password"},"meta":{"timestamp":"2026-04-25T03:48:42.189080Z","version":"0.1.0"}}
```
