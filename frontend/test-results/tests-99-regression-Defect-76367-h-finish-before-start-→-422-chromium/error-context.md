...
- Name: tests/99-regression.spec.ts >> Defect Regression Matrix >> BUG-001: Project create with finish-before-start → 422
- Location: e2e/tests/99-regression.spec.ts:14:7

# Error details

```
Error: API 401: {"error":{"code":"UNAUTHORIZED","message":"Invalid username or password"},"meta":{"timestamp":"2026-04-25T03:48:41.047919Z","version":"0.1.0"}}
```
