...
const CATEGORY_ORDER: Array<{ key: AgentMailRow["category"]; label: string }> = [
  ...
  { key: "ISSUE_REMINDER", label: "Overdue-issue reminders" },
  { key: "ISSUE_ESCALATION", label: "Overdue-issue escalations" },
  { key: "DPR_APPROVAL_OVERDUE", label: "DPR approval overdue" },
