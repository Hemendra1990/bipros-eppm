  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-600">Code: {data.projectCode} | Period: {data.period}</p>
          </div>
          <div className={`px-3 py-1 rounded-full text-sm font-semibold ${
            scheduleStatus === "completed" ? "bg-green-100 text-green-700" :
            scheduleStatus === "progressing" ? "bg-blue-100 text-blue-700" :
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs text-gray-500 uppercase tracking-wider">Total Activities</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">{data.completedActivities}</p>
            </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">{data.inProgressActivities}</p>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <h4 className="font-semibold text-gray-900 mb-4">Cost Status</h4>
          <div className="space-y-4">
            ...
            <div className="border-t pt-4">
              <div className="flex justify-between text-sm">
                <span className={costVariance.percentage >= 0 ? "text-green-600" : "text-red-600"}>
                  Variance
                </span>
                <span className={`font-semibold ${costVariance.percentage >= 0 ? "text-green-600" : "text-red-600"}`}>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between text-sm mb-1">
                ...
                <span className="font-semibold text-green-600">{data.achievedMilestones}</span>
              </div>
            </div>
            <div>
              <div className="flex justify-between text-sm mb-1">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-2 px-2 text-gray-600 font-semibold">Code</th>
                  <th className="text-left py-2 px-2 text-gray-600 font-semibold">Name</th>
                  <th className="text-left py-2 px-2 text-gray-600 font-semibold">Status</th>
                  <th className="text-right py-2 px-2 text-gray-600 font-semibold">Days Delayed</th>
                  <th className="text-left py-2 px-2 text-gray-600 font-semibold">Planned Finish</th>
                </tr>
              </thead>
              <tbody>
                {data.topDelayedActivities.map((activity, idx) => (
                  <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="py-3 px-2 font-mono text-gray-900">{activity.code}</td>
                    <td className="py-3 px-2 text-gray-700">{activity.name}</td>
