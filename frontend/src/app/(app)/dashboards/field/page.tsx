...
/**
 * The Field dashboard is now a project-scoped view living at
 * /projects/{projectId}/insights/field. This stub exists so old bookmarks
 * don't 404 — it routes the user to the project picker with a hint.
 */
export default function MovedFieldDashboardStub() {
  return (
    <div className="mx-auto max-w-2xl py-12 text-center">
      ...
      >
        Field dashboard moved
      </h1>
      <p className="mt-2 text-sm leading-relaxed text-slate">
        The Field dashboard is now a project-scoped view. Open a project and use the{" "}
