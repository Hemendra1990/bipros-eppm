...
export default function ActivityCodesPage() {
  ...
  if (isLoading && codes.length === 0) {
    return (
      <div className="flex h-64 items-center justify-center">
        <p className="text-text-muted">Loading activity codes...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 p-6">
      ...
      {showForm && (
        <div className="rounded border border-border bg-surface/80 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex gap-2">
              <button
                type="submit"
                className="rounded bg-green-600 px-4 py-2 text-text-primary hover:bg-green-600"
              >
              ...
              <button
                ...
                className="rounded bg-border px-4 py-2 text-text-primary hover:bg-surface-active"
              >
                Cancel
              </button>
            </div>
      ...
      {totalElements > 20 && (
        <div className="flex items-center justify-center gap-2">
          <button
            ...
            disabled={page === 0}
            className="rounded px-3 py-1 text-sm hover:bg-surface-active/50 disabled:opacity-50"
          >
            Previous
          </button>
