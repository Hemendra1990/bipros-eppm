...
- Name: tests/99-regression.spec.ts >> Defect Regression Matrix >> BUG-037: Baseline duplicate name → 422 DUPLICATE_CODE
- Location: e2e/tests/99-regression.spec.ts:88:7

# Error details

```
Error: API 401: {"error":{"code":"UNAUTHORIZED","message":"Invalid username or password"},"meta":{"timestamp":"2026-04-25T03:48:41.893696Z","version":"0.1.0"}}
```
