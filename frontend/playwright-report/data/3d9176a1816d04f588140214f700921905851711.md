...
- Name: tests/10-pms-masterdata.spec.ts >> PMS MasterData >> Projects list renders with PMS fields (category, chainage)
- Location: e2e/tests/10-pms-masterdata.spec.ts:12:7
