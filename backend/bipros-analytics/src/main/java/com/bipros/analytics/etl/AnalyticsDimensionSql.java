...
public final class AnalyticsDimensionSql {
    ...
    public static final String INSERT_ACTIVITY = """
        ...
        (activity_id, project_id, wbs_id, code, name, activity_type, uom, bq_quantity, planned_start, planned_finish,
         ...
         responsible_resource_id, responsible_resource_name,
        ...
        VALUES (:activityId, :projectId, :wbsId, :code, :name, :activityType, :uom, :bqQty,
                ...
                :responsibleResourceId, :responsibleResourceName,
    ...
    public static Map<String, Object> activityParams(Activity a,
        ...
        // Legacy supervisor columns. Activity entity now keeps these as @Transient
        // null fields; the new rows will leave them null. Phase 5 freezes the
        // writes entirely.
        ...
        // New: User-based supervisor + master work-activity link.
