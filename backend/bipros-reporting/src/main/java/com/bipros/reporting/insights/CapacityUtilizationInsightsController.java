...
@RestController
@RequestMapping("/v1/projects/{projectId}/capacity-utilization/ai")
@RequiredArgsConstructor
public class CapacityUtilizationInsightsController {

    private final CapacityUtilizationInsightsCollector collector;
