...
@RestController
@RequestMapping("/v1/projects/{projectId}/insights/manpower-kpi")
@RequiredArgsConstructor
public class ManpowerKpiInsightsController {

  private final ManpowerKpiInsightsCollector collector;
