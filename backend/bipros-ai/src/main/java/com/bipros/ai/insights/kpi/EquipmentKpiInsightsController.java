...
@RestController
@RequestMapping("/v1/projects/{projectId}/insights/equipment-kpi")
@RequiredArgsConstructor
public class EquipmentKpiInsightsController {

  private final EquipmentKpiInsightsCollector collector;
  ...
  @PostMapping("/refresh")
  @PreAuthorize("hasAnyRole('ADMIN','PROJECT_MANAGER')")
  public ResponseEntity<ApiResponse<InsightsResponse>> refresh(@PathVariable UUID projectId) {
