...
@RestController
@RequestMapping("/v1/projects/{projectId}/period-performance/ai")
@RequiredArgsConstructor
public class PeriodPerformanceInsightsController {

    private final PeriodPerformanceInsightsCollector collector;
